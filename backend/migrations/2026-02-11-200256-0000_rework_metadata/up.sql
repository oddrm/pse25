...
ALTER TABLE "entries" ADD COLUMN "sequence_lon_starting_point_deg" DOUBLE PRECISION;
ALTER TABLE "entries" ADD COLUMN "scenario_name" VARCHAR;
ALTER TABLE "entries" ADD COLUMN "scenario_description" TEXT;
ALTER TABLE "entries" ADD COLUMN "sequence_lat_starting_point_deg" DOUBLE PRECISION;
ALTER TABLE "entries" ADD COLUMN "tags" TEXT[] NOT NULL;
ALTER TABLE "entries" ADD COLUMN "sequence_duration" DOUBLE PRECISION;
...
ALTER TABLE "entries" ADD COLUMN "sequence_distance" DOUBLE PRECISION;
